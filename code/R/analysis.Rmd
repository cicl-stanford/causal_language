...
ggplot(df_to_show,
  ...
  geom_bar(fill = "grey",
           color = "black") +
  geom_vline(data = df_med,
             mapping = aes(xintercept = med_resp),
             color = "red") +
  geom_linerange(data = df_boots,
                 mapping = aes(x = response,
                                ymin = low,
...
ggsave("../../figures/paper_figures/semantics_exp_frames_AE_alt.pdf",
       height = 12,
       width = 12)
...
ggplot(df_to_show,
  ...
  coord_cartesian(clip = "off") +
  scale_x_continuous(breaks = seq(1,7)) +
  scale_fill_manual(values = c("springgreen3", "darkorchid1")) +
  scale_color_manual(values = c("springgreen3", "darkorchid1")) +
  scale_linewidth_manual(values = c(0.5, 1.2)) +
  xlab("Response") +
  ylab("Count") +
...
ggsave("../../figures/paper_figures/pragmatics_exp_frames_CE_alt.pdf",
       height = 12,
       width = 12)
```
