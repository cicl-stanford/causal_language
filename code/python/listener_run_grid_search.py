...
if model_type == "full":
	...
	reg_pairings = lmf.get_regression_pairings(speaker_regression, lmf.trial_comparison_indices, lmf.trial_utterance_values)

	opt_beta = minimize_scalar(lmf.reg_square_error, args=(reg_pairings, lmf.scaled_human_responses))["x"]
